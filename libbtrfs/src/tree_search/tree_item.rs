...
use crate::bindings::{
    ...
    BTRFS_DEV_EXTENT_KEY, BTRFS_DEV_ITEM_KEY, BTRFS_DEV_REPLACE_KEY, BTRFS_DEV_STAT_VALUES_MAX,
    ...
    BTRFS_INODE_EXTREF_KEY, BTRFS_INODE_ITEM_KEY, BTRFS_INODE_REF_KEY, BTRFS_METADATA_ITEM_KEY,
    BTRFS_ORPHAN_ITEM_KEY, BTRFS_PERSISTENT_ITEM_KEY, BTRFS_QGROUP_INFO_KEY,
    BTRFS_QGROUP_LIMIT_KEY, BTRFS_QGROUP_RELATION_KEY, BTRFS_QGROUP_STATUS_KEY,
    BTRFS_ROOT_BACKREF_KEY, BTRFS_ROOT_ITEM_KEY, BTRFS_ROOT_REF_KEY, BTRFS_TEMPORARY_ITEM_KEY,
    BTRFS_UUID_KEY_RECEIVED_SUBVOL, BTRFS_UUID_KEY_SUBVOL, BTRFS_XATTR_ITEM_KEY,
    btrfs_balance_item, btrfs_block_group_item, btrfs_chunk, btrfs_csum_item, btrfs_dev_extent,
    btrfs_dev_item, btrfs_dev_replace_item, btrfs_dev_stats_item, btrfs_dir_item,
    btrfs_dir_log_item, btrfs_disk_balance_args, btrfs_disk_key, btrfs_extent_data_ref,
    btrfs_extent_inline_ref, btrfs_extent_item, btrfs_file_extent_item, btrfs_free_space_header,
    btrfs_free_space_info, btrfs_inode_extref, btrfs_inode_item, btrfs_inode_ref,
    btrfs_ioctl_timespec, btrfs_qgroup_info_item, btrfs_qgroup_limit_item,
    btrfs_qgroup_status_item, btrfs_root_item, btrfs_root_ref, btrfs_shared_data_ref, btrfs_stripe,
    btrfs_timespec,
};
use uuid::Uuid;
...
{
    fn name_as_bytes(self) -> io::Result<&'buf [u8]>
    {
    ...
    fn name_as_os_str(self) -> io::Result<&'buf OsStr>
    {
