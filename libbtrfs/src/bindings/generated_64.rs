...
compile_error!("Requires 64 bit architecture");
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of vol_args_v2_qgroup_opts"][::std::mem::size_of::<vol_args_v2_qgroup_opts>() - 16usize];
    ["Alignment of vol_args_v2_qgroup_opts"]
        [::std::mem::align_of::<vol_args_v2_qgroup_opts>() - 8usize];
...
const _: () = {
    ...
    ["Alignment of vol_args_v2_qgroup"][::std::mem::align_of::<vol_args_v2_qgroup>() - 8usize];
...
const _: () = {
    ...
    ["Alignment of vol_args_v2_volume"][::std::mem::align_of::<vol_args_v2_volume>() - 8usize];
...
const _: () = {
    ...
    ["Alignment of btrfs_ioctl_subvol_wait"]
        [::std::mem::align_of::<btrfs_ioctl_subvol_wait>() - 8usize];
...
const _: () = {
    ...
    ["Alignment of btrfs_ioctl_get_csums_entry"]
        [::std::mem::align_of::<btrfs_ioctl_get_csums_entry>() - 8usize];
...
const _: () = {
    ...
    ["Alignment of btrfs_ioctl_get_csums_args"]
        [::std::mem::align_of::<btrfs_ioctl_get_csums_args>() - 8usize];
...
pub const BTRFS_IOC_SET_RECEIVED_SUBVOL: request_t = 3234370597;
pub const BTRFS_IOC_SEND: request_t = 1078498342;
...
pub const BTRFS_IOC_DEV_REPLACE: request_t = 3391657013;
...
pub const BTRFS_IOC_GET_SUBVOL_INFO: request_t = 2180551740;
...
pub const BTRFS_IOC_ENCODED_READ: request_t = 2155910208;
pub const BTRFS_IOC_ENCODED_WRITE: request_t = 1082168384;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iovec {
    pub _address: u8,
